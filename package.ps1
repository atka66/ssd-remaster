...
$source = "acs/", "actors/", "flats/", "graphics/", "maps/", "models/", "music/", "sounds/", "sprites/", "textures/", "voxels/", "ANIMDEFS", "CVARINFO", "DECALDEF", "DECORATE", "DEHACKED", "DOOMDEFS", "GAMEINFO", "KEYCONF", "LOADACS", "LOCKDEFS", "MAPINFO", "MENUDEF", "MODELDEF", "PNAMES", "SNDINFO", "SNDSEQ", "STARS", "TEXTURE1", "VOXELDEF"
